...
Calling forEach(): The forEach() method is used to iterate over each element in the array. 
The forEach() method accepts a callback function that is executed once for each item in the array. 
In this case, the callback function is function(item) { console.log(item); }.
